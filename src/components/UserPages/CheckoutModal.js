  ...
  return (
    <Modal size="lg" show={props.showCheckoutModal} onHide={closeCheckoutModal}>
      <Modal.Header closeButton>
        <Modal.Title>
          <img src={logo} alt="..." style={{ width: "30%", height:"40%" }} />
        </Modal.Title>
      </Modal.Header>
        ...
        <div style={{ fontFamily: "Karla,sans-serif" }}>
          <div>
            <p
              ...
              style={{ border: "2.5px dashed #7f0c0c" }}
            >
          ...
          <div className="d-flex justify-content-center mt-4">
            ...
            <div
              className="mx-5"
              style={{ borderLeft: "2px solid #7f0c0c", height: "3rem" }}
            />
            <p className="text-center text-secondary my-0">
              Total: <br />
          ...
          <div>
            ...
            <table class="table">
              <thead style={{ backgroundColor: "#7f0c0c", color: "white" }}>
                <tr>
                  <th scope="col">#</th>
          ...
          <div
            className="mt-4 mb-2"
            style={{ borderTop: "2px solid #7f0c0c" }}
          />
          <div>
